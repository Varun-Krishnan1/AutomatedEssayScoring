...
N1 = np.loadtxt("../Feature Selection Cheating/SampleEssaysFeaturesTruncCheatingNormalizedFiltered/Cheating-SampleEssays-gamet-filtered.csv", dtype='str', delimiter=',', max_rows=1, usecols=tuple(range(1,13)))
N2 = np.loadtxt("../Feature Selection Cheating/SampleEssaysFeaturesTruncCheatingNormalizedFiltered/Cheating-SampleEssays-seance-filtered.csv", dtype='str', delimiter=',', max_rows=1, usecols=tuple(range(1,98)))
N3 = np.loadtxt("../Feature Selection Cheating/SampleEssaysFeaturesTruncCheatingNormalizedFiltered/Cheating-SampleEssays-taaco-filtered.csv", dtype='str', delimiter=',', max_rows=1, usecols=tuple(range(1,77)))
N4 = np.loadtxt("../Feature Selection Cheating/SampleEssaysFeaturesTruncCheatingNormalizedFiltered/Cheating-SampleEssays-taaled-filtered.csv", dtype='str', delimiter=',', max_rows=1, usecols=tuple(range(1,15)))
N5 = np.loadtxt("../Feature Selection Cheating/SampleEssaysFeaturesTruncCheatingNormalizedFiltered/Cheating-SampleEssays-taales-filtered.csv", dtype='str', delimiter=',', max_rows=1, usecols=tuple(range(1,109)))
N6 = np.loadtxt("../Feature Selection Cheating/SampleEssaysFeaturesTruncCheatingNormalizedFiltered/Cheating-SampleEssays-taassc-filtered.csv", dtype='str', delimiter=',', max_rows=1, usecols=tuple(range(1,80)))
N7 = np.loadtxt("../Feature Selection Cheating/SampleEssaysFeaturesTruncCheatingNormalizedFiltered/Cheating-SampleEssays-components-filtered.csv", dtype='str', delimiter=',', max_rows=1, usecols=tuple(range(1,6)))
N8 = np.loadtxt("../Feature Selection Cheating/SampleEssaysFeaturesTruncCheatingNormalizedFiltered/Cheating-SampleEssays-sca-filtered.csv", dtype='str', delimiter=',', max_rows=1, usecols=tuple(range(1,7)))
